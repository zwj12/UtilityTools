...
logFilePath = r'C:\ProgramData\ABB\PickMaster Twin\PickMaster Twin Runtime\PickMaster Runtime\Log\PMTWSensor2Functions.log'
...
def get_logging():
    ...
    logger = logging.getLogger('PMTWSensor2Functions')
...
class Sensor2Functions:
    ...
    def showSensorConfigDialog(self, inputTitle: str, configInfo: str):
        ...
        sensorConfigWindow.title("Sensor2: " + inputTitle)
    ...
    def showPosGenConfigDialog(self, inputTitle: str, configInfo: str):
        ...
        posGenConfigWindow.title("Sensor2 PosGens: " + inputTitle)
