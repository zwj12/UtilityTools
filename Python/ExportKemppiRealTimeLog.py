...
regularCurrentR = regularTime + r'.*Right.*: ([0-9]+)'
regularCurrentL = regularTime + r'.*Left.*: ([0-9]+)'
...
strLogFileName = "Kemppi_RealTimeLog_ROB2.log"
...
fileLogCSV_Y = open('Kemppi_RealTimeLog_ROB2_Y.csv', 'w')
fileLogCSV_Z = open('Kemppi_RealTimeLog_ROB2_Z.csv', 'w')
